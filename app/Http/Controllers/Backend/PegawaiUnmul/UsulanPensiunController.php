...
class UsulanPensiunController extends Controller
{
    ...
    public function index()
    {
        ...
        // Debug information
        Log::info('UsulanPensiunController@index Debug', [
        ...
        return view('backend.layouts.views.pegawai-unmul.usulan-pensiun.index', compact('periodeUsulans', 'usulans', 'pegawai'));
    }
