...
class UsulanSatyalancanaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // Debug information
        Log::info('UsulanSatyalancanaController@index Debug', [
        ...
        return view('backend.layouts.views.pegawai-unmul.usulan-satyalancana.index', compact('periodeUsulans', 'usulans', 'pegawai'));
    }
    ...
    public function create()
    {
        ...
        return redirect()->route('pegawai-unmul.usulan-pegawai.dashboard')
                         ->with('info', 'Fitur Usulan Satyalancana akan segera tersedia.');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pegawai-unmul.usulan-satyalancana.index')
                         ->with('success', 'Usulan Satyalancana berhasil dibuat.');
    }
    ...
    public function show(Usulan $usulan)
    {
        ...
        return view('backend.layouts.views.pegawai-unmul.usulan-satyalancana.show', compact('usulan'));
    }
    ...
    public function edit(Usulan $usulan)
    {
        ...
        return view('backend.layouts.views.pegawai-unmul.usulan-satyalancana.edit', compact('usulan'));
    }
    ...
    public function update(Request $request, Usulan $usulan)
    {
        ...
        // Implementation akan ditambahkan nanti
        return redirect()->route('pegawai-unmul.usulan-satyalancana.index')
                         ->with('success', 'Usulan Satyalancana berhasil diperbarui.');
    }
    ...
    public function destroy(Usulan $usulan)
    {
        ...
        // Implementation akan ditambahkan nanti
        return redirect()->route('pegawai-unmul.usulan-satyalancana.index')
                         ->with('success', 'Usulan Satyalancana berhasil dihapus.');
    }
