...
class UsulanPencantumanGelarController extends Controller
{
    ...
    public function index()
    {
        ...
        // Debug information
        Log::info('UsulanPencantumanGelarController@index Debug', [
        ...
        return view('backend.layouts.views.pegawai-unmul.usulan-pencantuman-gelar.index', compact('periodeUsulans', 'usulans', 'pegawai'));
    }
    ...
    {
        return 'Usulan Pencantuman Gelar';
    }
