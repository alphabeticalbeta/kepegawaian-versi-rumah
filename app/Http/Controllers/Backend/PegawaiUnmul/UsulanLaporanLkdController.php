...
class UsulanLaporanLkdController extends Controller
{
    ...
    public function index()
    {
        ...
        // Debug information
        Log::info('UsulanLaporanLkdController@index Debug', [
        ...
        return view('backend.layouts.views.pegawai-unmul.usulan-laporan-lkd.index', compact('periodeUsulans', 'usulans', 'pegawai'));
    }
