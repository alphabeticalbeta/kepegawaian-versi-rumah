...
class UsulanUjianDinasIjazahController extends Controller
{
    ...
    public function index()
    {
        ...
        // Debug information
        Log::info('UsulanUjianDinasIjazahController@index Debug', [
        ...
        return view('backend.layouts.views.pegawai-unmul.usulan-ujian-dinas-ijazah.index', compact('periodeUsulans', 'usulans', 'pegawai'));
    }
    ...
    {
        return 'Usulan Ujian Dinas & Ijazah';
    }
