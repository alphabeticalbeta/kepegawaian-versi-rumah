...
class UsulanPresensiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // Debug information
        Log::info('UsulanPresensiController@index Debug', [
        ...
        return view('backend.layouts.views.pegawai-unmul.usulan-presensi.index', compact('periodeUsulans', 'usulans', 'pegawai'));
    }
    ...
    public function create()
    {
        ...
        return redirect()->route('pegawai-unmul.usulan-pegawai.dashboard')
                         ->with('info', 'Fitur Usulan Presensi akan segera tersedia.');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pegawai-unmul.usulan-presensi.index')
                         ->with('success', 'Usulan Presensi berhasil dibuat.');
    }
    ...
    public function show(Usulan $usulan)
    {
        ...
        return view('backend.layouts.views.pegawai-unmul.usulan-presensi.show', compact('usulan'));
    }
    ...
    public function edit(Usulan $usulan)
    {
        ...
        return view('backend.layouts.views.pegawai-unmul.usulan-presensi.edit', compact('usulan'));
    }
    ...
    public function update(Request $request, Usulan $usulan)
    {
        ...
        // Implementation akan ditambahkan nanti
        return redirect()->route('pegawai-unmul.usulan-presensi.index')
                         ->with('success', 'Usulan Presensi berhasil diperbarui.');
    }
    ...
    public function destroy(Usulan $usulan)
    {
        ...
        // Implementation akan ditambahkan nanti
        return redirect()->route('pegawai-unmul.usulan-presensi.index')
                         ->with('success', 'Usulan Presensi berhasil dihapus.');
    }
