...
class UsulanPenyesuaianMasaKerjaController extends Controller
{
    ...
    public function index()
    {
        ...
        // Debug information
        Log::info('UsulanPenyesuaianMasaKerjaController@index Debug', [
        ...
        return view('backend.layouts.views.pegawai-unmul.usulan-penyesuaian-masa-kerja.index', compact('periodeUsulans', 'usulans', 'pegawai'));
    }
    ...
    {
        return 'Usulan Penyesuaian Masa Kerja';
    }
