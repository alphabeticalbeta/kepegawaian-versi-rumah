    ...
    <nav class="flex-1 overflow-y-auto py-2">
        ...
        @php
            $masterMenus = [
                ...
                ['route' => 'backend.admin-univ-usulan.sub-unitkerja.index', 'icon' => 'building', 'label' => 'Sub Unit Kerja', 'pattern' => 'backend.admin-univ-usulan.sub-unitkerja.*'],
                ['route' => 'backend.admin-univ-usulan.sub-sub-unitkerja.index', 'icon' => 'book-open', 'label' => 'Sub-Sub Unit Kerja', 'pattern' => 'backend.admin-univ-usulan.sub-sub-unitkerja.*'],
        ...
        <div class="mb-2 px-2">
            ...
            <div id="dropdown-usulan" class="dropdown-menu {{ $isUsulanActive ? '' : 'hidden' }} space-y-1 pl-4 mt-1">
                ...
                <div class="relative">
                    <a href="{{ route('backend.admin-univ-usulan.pusat-usulan.index', ['tab' => 'jabatan']) }}" class="flex items-center px-3 py-2.5 rounded-lg text-gray-700 hover:bg-gray-100">
