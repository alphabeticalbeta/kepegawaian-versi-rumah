...
@if($isEditing)
    @push('scripts')
    <script>
        // Handle document access dengan error handling
        function handleDocumentAccess(event, element) {
            ...
            // Reset setelah 3 detik jika masih loading
            setTimeout(() => {
        ...
        // Update upload summary dynamically
        function updateUploadSummary() {
            ...
            // You can add logic here to update summary counts if needed
        }
