                            ...
                            <td class="px-6 py-4 text-center align-middle">
                                @if($existingUsulan)
                                    ...
                                    <div class="flex items-center justify-center space-x-2">
                                        <a href="{{ route('pegawai-unmul.usulan-ujian-dinas-ijazah.show', $existingUsulan->id) }}"
                                ...
                                @else
                                    ...
                                    <a href="{{ route('pegawai-unmul.usulan-ujian-dinas-ijazah.create') }}?periode_id={{ $periode->id }}"
...
function showLogs(usulanId) {
    ...
    // Fetch logs
    fetch(`/pegawai-unmul/usulan-ujian-dinas-ijazah/${usulanId}/logs`)
