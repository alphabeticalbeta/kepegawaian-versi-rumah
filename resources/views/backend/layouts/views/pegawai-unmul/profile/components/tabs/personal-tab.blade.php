        ...
        <div>
            ...
            @if($isEditing)
                <input type="text" name="nama_lengkap"
                       ...
                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 @error('nama_lengkap') border-red-500 @enderror"
                       required>
                @error('nama_lengkap')
        ...
        <div>
            ...
            @if($isEditing)
                <input type="email" name="email"
                       ...
                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 @error('email') border-red-500 @enderror"
                       required>
                @error('email')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
