...
@section('title', 'Usulan Presensi Saya')
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">
                    Usulan Presensi Saya
                </h1>
                <p class="mt-2 text-gray-600">
                    Pantau status dan riwayat usulan Presensi yang telah Anda ajukan.
                </p>
            </div>
            <a href="{{ route('pegawai-unmul.usulan-presensi.create') }}"
    ...
    <div class="bg-white shadow-xl rounded-2xl border border-gray-200 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
            <h3 class="text-lg font-semibold text-gray-800">
                Daftar Usulan Presensi
            </h3>
            <p class="text-sm text-gray-500 mt-1">
                Berikut adalah semua usulan Presensi yang pernah Anda buat.
            </p>
        </div>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center space-x-2">
                                        <a href="{{ route('pegawai-unmul.usulan-presensi.show', $usulan->id) }}"
                                           class="text-indigo-600 hover:text-indigo-900 font-medium text-sm">
                                            Detail
                                        </a>
                                        @if($usulan->status_usulan === 'Draft')
                                            <a href="{{ route('pegawai-unmul.usulan-presensi.edit', $usulan->id) }}"
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Anda belum pernah membuat usulan Presensi.
                    </p>
                    <div class="mt-6">
                        <a href="{{ route('pegawai-unmul.usulan-presensi.create') }}"
