...
@section('title', 'Usulan ID SINTA ke SISTER Saya')
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">
                    Usulan ID SINTA ke SISTER Saya
                </h1>
                <p class="mt-2 text-gray-600">
                    Pantau status dan riwayat usulan ID SINTA ke SISTER yang telah Anda ajukan.
                </p>
            </div>
            <a href="{{ route('pegawai-unmul.usulan-id-sinta-sister.create') }}"
    ...
    <div class="bg-white shadow-xl rounded-2xl border border-gray-200 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
            <h3 class="text-lg font-semibold text-gray-800">
                Daftar Usulan ID SINTA ke SISTER
            </h3>
            <p class="text-sm text-gray-500 mt-1">
                Berikut adalah semua usulan ID SINTA ke SISTER yang pernah Anda buat.
            </p>
        </div>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center space-x-2">
                                        <a href="{{ route('pegawai-unmul.usulan-id-sinta-sister.show', $usulan->id) }}"
                                           class="text-indigo-600 hover:text-indigo-900 font-medium text-sm">
                                            Detail
                                        </a>
                                        @if($usulan->status_usulan === 'Draft')
                                            <a href="{{ route('pegawai-unmul.usulan-id-sinta-sister.edit', $usulan->id) }}"
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Anda belum pernah membuat usulan ID SINTA ke SISTER.
                    </p>
                    <div class="mt-6">
                        <a href="{{ route('pegawai-unmul.usulan-id-sinta-sister.create') }}"
