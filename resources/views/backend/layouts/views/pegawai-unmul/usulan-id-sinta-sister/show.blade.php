...
@section('title', 'Detail Usulan ID SINTA ke SISTER')
            ...
            <div class="py-6 flex flex-wrap gap-4 justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">
                        Detail Usulan ID SINTA ke SISTER
                    </h1>
                    <p class="mt-1 text-sm text-gray-500">
                        Informasi lengkap Usulan ID SINTA ke SISTER
                    </p>
                </div>
                    ...
                    @foreach($usulan->data_usulan['dokumen_usulan'] as $docType => $docData)
                        ...
                        <div class="border border-gray-200 rounded-lg p-4">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('pegawai-unmul.usulan-id-sinta-sister.show-document', ['usulan-id-sinta-sister' => $usulan->id, 'field' => $docType]) }}"
                                   target="_blank"
