{{-- Component Daftar Pengusul NUPTK - Hanya untuk jenis usulan NUPTK --}}
@if(isset($filter) && $filter === 'jenis_nuptk' && isset($filterValue))
<div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border border-white/30 p-6 mb-6">
        ...
        <table class="w-full text-sm text-left text-slate-600">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-center">
                        <a href="{{ route('backend.kepegawaian-universitas.usulan.validasi-nuptk', $usulan->id) }}" 
    ...
    <div class="text-center py-8">
        ...
        <p class="text-slate-400 text-sm">Untuk jenis usulan NUPTK: {{ $filterValue }}</p>
    </div>
    @endif
</div>
@endif
