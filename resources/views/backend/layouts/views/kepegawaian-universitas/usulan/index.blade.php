...
@section('title', $namaUsulan . ' - Kepegawaian Universitas')
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4">
    ...
    <div class="flex flex-wrap gap-4 mb-6">
        <form action="{{ route('backend.kepegawaian-universitas.usulan.toggle-periode') }}" method="POST" class="inline">
            @csrf
                    ...
                    @forelse($usulans as $index => $usulan)
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex gap-2">
                                    <a href="{{ route('backend.kepegawaian-universitas.usulan.show', $usulan) }}"
