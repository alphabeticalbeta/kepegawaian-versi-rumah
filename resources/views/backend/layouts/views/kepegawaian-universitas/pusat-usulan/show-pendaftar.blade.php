...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center space-x-2 text-sm text-gray-500 mb-4">
            <a href="{{ route('backend.kepegawaian-universitas.pusat-usulan.index') }}" class="hover:text-gray-700 transition-colors">
                Manajemen Usulan
            </a>
                ...
                <tbody>
                    @forelse ($usulans as $usulan)
                        <tr class="bg-white border-b hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('backend.kepegawaian-universitas.pusat-usulan.show', $usulan->id) }}" class="font-medium text-indigo-600 hover:text-indigo-900">Detail</a>
                            </td>
                        </tr>
                    @empty
