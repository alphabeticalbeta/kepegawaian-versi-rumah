...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl border border-white/30 overflow-hidden">
            ...
            <div class="p-6">
                <form action="{{ isset($item) ? route('backend.kepegawaian-universitas.unitkerja.update', ['type' => $type, 'id' => $item->id]) : route('backend.kepegawaian-universitas.unitkerja.store') }}"
                      method="POST"
                      class="space-y-6">
                    @csrf
                    @if(isset($item))
                    ...
                    <div class="flex items-center justify-end gap-4 pt-6 border-t border-slate-200">
                        <a href="{{ route('backend.kepegawaian-universitas.unitkerja.index') }}"
