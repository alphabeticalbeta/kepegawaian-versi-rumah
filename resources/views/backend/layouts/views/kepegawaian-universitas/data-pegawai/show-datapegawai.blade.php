...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex justify-between items-center border-b pb-4 mb-4">
            ...
            <a href="{{ route('backend.kepegawaian-universitas.data-pegawai.index') }}" class="bg-gray-200 hover:bg-gray-300 text-black font-bold py-2 px-4 rounded">
                &larr; Kembali
            </a>
        </div>
                ...
                @foreach ($dokumenList as $field => $label)
                    @if($pegawai->$field)
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg border">
                            ...
                            {{-- UBAH TAUTAN DI SINI --}}
                            <a href="{{ route('backend.kepegawaian-universitas.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => $field]) }}" target="_blank"
