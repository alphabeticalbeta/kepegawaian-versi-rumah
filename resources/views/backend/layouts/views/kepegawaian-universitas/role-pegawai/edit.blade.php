            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    <div class="flex items-center gap-3 mb-2">
                        <a href="{{ route('backend.kepegawaian-universitas.role-pegawai.index') }}"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="p-3 bg-slate-50 rounded-xl">
                            ...
                            <div class="flex flex-wrap gap-1">
                                @forelse($pegawai->roles as $role)
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        {{ $role->name == 'Kepegawaian Universitas' ? 'bg-red-100 text-red-800' :
            ...
            <div class="lg:col-span-2">
                <div class="bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl border border-white/30 overflow-hidden">
                    ...
                    <form action="{{ route('backend.kepegawaian-universitas.role-pegawai.update', $pegawai) }}" method="POST" class="p-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="bg-slate-50 rounded-xl p-6">
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h5 class="font-medium text-slate-800">Kepegawaian Universitas</h5>
