            ...
            <div class="relative px-6 py-16 sm:px-8 sm:py-24">
                <div class="mx-auto max-w-4xl text-center">
                    ...
                    <p class="text-xl text-blue-100 sm:text-2xl font-medium">
                        Admin Informasi Kepegawaian Universitas
                    </p>
                    <div class="mt-8">
        ...
        <div class="relative z-10 -mt-16 px-6 sm:px-8">
            <div class="mx-auto max-w-7xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    <!-- Card 1: Manajemen Periode -->
                    <div class="bg-white rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300 border-l-4 border-indigo-500">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="ml-3 text-lg font-semibold text-gray-900">Manajemen Periode</h3>
                        </div>
                        <p class="text-gray-600 text-sm">Kelola periode usulan dan jadwal pengajuan dengan sistem terintegrasi</p>
                    </div>

                    <!-- Card 2: Dashboard Usulan -->
                    <div class="bg-white rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300 border-l-4 border-purple-500">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="ml-3 text-lg font-semibold text-gray-900">Dashboard Usulan</h3>
                        </div>
                        <p class="text-gray-600 text-sm">Pemantauan real-time status usulan dan progress pengajuan</p>
                    </div>

                    <!-- Card 3: Informasi Kepegawaian -->
                    <div class="bg-white rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300 border-l-4 border-pink-500">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="ml-3 text-lg font-semibold text-gray-900">Informasi Kepegawaian</h3>
                        </div>
                        <p class="text-gray-600 text-sm">Akses informasi dan data kepegawaian universitas secara terpusat</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-3xl shadow-2xl p-8 text-center mb-12">
                    <div class="max-w-3xl mx-auto">
                        ...
                        <h2 class="text-3xl font-bold text-gray-800 mb-4">
                            Selamat Datang di Dashboard Admin Universitas
                        </h2>
                        <p class="text-lg text-gray-600 leading-relaxed">
                            Sebagai Admin Universitas, Anda memiliki akses penuh untuk mengelola periode usulan,
                            memantau dashboard usulan, dan mengakses informasi kepegawaian universitas secara terpusat.
                        </p>
