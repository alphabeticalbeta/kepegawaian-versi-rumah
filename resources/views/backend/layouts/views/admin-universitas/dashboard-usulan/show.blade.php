...
@section('title', 'Dashboard Periode: ' . $periode->nama_periode . ' - Admin Universitas')
    ...
    <div class="admin-universitas-bg text-white p-6 rounded-2xl mb-6 shadow-2xl">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-indigo-100">{{ $periode->jenis_usulan }} • Tahun {{ $periode->tahun_periode }}</p>
    ...
    <div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border border-white/30">
        <div class="p-6 border-b border-slate-200">
            <div class="flex items-center justify-between">
                ...
                <button class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors text-sm">
                    Lihat Semua
                </button>
            </div>
        </div>
