...
@section('title', 'Dashboard Usulan Pangkat')

@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Header Halaman -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Dashboard Usulan Pangkat</h1>
            <p class="mt-1 text-sm text-gray-600">
                Selamat datang, <span class="font-medium">{{ Auth::user()->nama_lengkap ?? 'Admin' }}</span>.
                @if($unitKerja)
                    Anda mengelola usulan pangkat untuk <span class="font-semibold text-indigo-600">{{ $unitKerja->nama }}</span>.
                @else
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-purple-700">
                            ...
                            Total periode pangkat: {{ $statistics['total_periode'] }} |
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($periodeUsulans as $periode)
                            ...
                            <tr class="{{ $isPeriodClosed && !$hasUsulan ? 'opacity-50' : '' }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <span class="text-sm font-medium text-emerald-600">{{ $periode->dikirim_universitas }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-4 text-center text-gray-500">
                                    <div class="flex flex-col items-center py-8">
                                        <i data-lucide="award" class="w-12 h-12 text-gray-300 mb-4"></i>
                                        <p class="text-lg font-medium text-gray-900 mb-2">Tidak ada periode usulan pangkat</p>
                                        <p class="text-sm text-gray-500">Belum ada periode usulan pangkat yang tersedia saat ini.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
