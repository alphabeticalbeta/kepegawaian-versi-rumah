{{-- Perbaikan dari Admin Fakultas untuk Role Kepegawaian Universitas Section --}}
@if($currentRole === 'Kepegawaian Universitas' && $usulan->status_usulan === 'Permintaan Perbaikan dari Admin Fakultas' && !empty($usulan->catatan_verifikator) && isset($usulan->validasi_data['admin_fakultas']['validation']))
