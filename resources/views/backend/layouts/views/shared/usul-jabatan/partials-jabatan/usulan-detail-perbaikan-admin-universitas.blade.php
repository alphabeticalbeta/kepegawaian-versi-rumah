...
@if($currentRole === 'Admin Fakultas' && $usulan->status_usulan === 'Permintaan Perbaikan dari Admin Fakultas' && !empty($usulan->catatan_verifikator))
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4">
                ...
                @if(isset($usulan->validasi_data['admin_universitas']['validation']))
                    ...
                    @if(!empty($invalidFields))
                        <div class="mt-4">
                            <h5 class="text-sm font-medium text-red-800 mb-2">Field yang Tidak Sesuai:</h5>
                            <div class="space-y-2">
