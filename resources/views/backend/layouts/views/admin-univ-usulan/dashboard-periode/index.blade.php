...
@section('title', 'Dashboard ' . $namaUsulan . ' - Admin Universitas Usulan')
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4">
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <a href="{{ route('backend.admin-univ-usulan.periode-usulan.index') }}"
               class="bg-white/90 backdrop-blur-xl p-6 rounded-xl shadow-lg border border-white/30 hover:shadow-xl transition-all duration-300 flex items-center group">
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center justify-center space-x-1 sm:space-x-2">
                                        <!-- Lihat Data Pengusul -->
                                        <a href="{{ route('backend.admin-univ-usulan.dashboard-periode.show', $periode) }}"
                                        ...
                                        @if($periode->usulans_count == 0)
                                            <form action="{{ route('backend.admin-univ-usulan.periode-usulan.destroy', $periode) }}"
                                                  method="POST"
                                                  class="inline-block"
