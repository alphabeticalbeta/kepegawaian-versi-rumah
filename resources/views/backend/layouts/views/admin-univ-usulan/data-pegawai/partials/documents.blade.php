        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-4 lg:gap-6">
            ...
            <div class="group">
                ...
                <div class="relative">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('backend.admin-univ-usulan.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => 'ijazah_terakhir']) }}"
                           target="_blank"
            ...
            <div class="group">
                ...
                <div class="relative">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('backend.admin-univ-usulan.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => 'transkrip_nilai_terakhir']) }}"
                           target="_blank"
                           class="inline-flex items-center gap-2 text-xs font-semibold text-indigo-600 hover:text-indigo-800 hover:underline transition-colors bg-indigo-50 px-3 py-2 rounded-lg hover:bg-indigo-100">
                            <i data-lucide="eye" class="w-3 h-3"></i>Lihat File Saat Ini
                        </a>
            ...
            <div class="group">
                ...
                <div class="relative">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('backend.admin-univ-usulan.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => 'sk_penyetaraan_ijazah']) }}"
                           target="_blank"
                           class="inline-flex items-center gap-2 text-xs font-semibold text-indigo-600 hover:text-indigo-800 hover:underline transition-colors bg-indigo-50 px-3 py-2 rounded-lg hover:bg-indigo-100">
                            <i data-lucide="eye" class="w-3 h-3"></i>Lihat File Saat Ini
                        </a>
            ...
            <div class="group">
                ...
                <div class="relative">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('backend.admin-univ-usulan.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => 'disertasi_thesis_terakhir']) }}"
                           target="_blank"
                           class="inline-flex items-center gap-2 text-xs font-semibold text-indigo-600 hover:text-indigo-800 hover:underline transition-colors bg-indigo-50 px-3 py-2 rounded-lg hover:bg-indigo-100">
                            <i data-lucide="eye" class="w-3 h-3"></i>Lihat File Saat Ini
                        </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="group">
                ...
                <div class="relative">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('backend.admin-univ-usulan.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => 'sk_cpns']) }}"
                           target="_blank"
                           class="inline-flex items-center gap-2 text-xs font-semibold text-indigo-600 hover:text-indigo-800 hover:underline transition-colors bg-indigo-50 px-3 py-2 rounded-lg hover:bg-indigo-100">
                            <i data-lucide="eye" class="w-3 h-3"></i>Lihat File Saat Ini
                        </a>
            ...
            <div class="group">
                ...
                <div class="relative">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('backend.admin-univ-usulan.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => 'sk_pns']) }}"
                           target="_blank"
                           class="inline-flex items-center gap-2 text-xs font-semibold text-indigo-600 hover:text-indigo-800 hover:underline transition-colors bg-indigo-50 px-3 py-2 rounded-lg hover:bg-indigo-100">
                            <i data-lucide="eye" class="w-3 h-3"></i>Lihat File Saat Ini
                        </a>
            ...
            <div class="group">
                ...
                <div class="relative">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('backend.admin-univ-usulan.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => 'sk_pangkat_terakhir']) }}"
                           target="_blank"
                           class="inline-flex items-center gap-2 text-xs font-semibold text-indigo-600 hover:text-indigo-800 hover:underline transition-colors bg-indigo-50 px-3 py-2 rounded-lg hover:bg-indigo-100">
                            <i data-lucide="eye" class="w-3 h-3"></i>Lihat File Saat Ini
                        </a>
            ...
            <div class="group">
                ...
                <div class="relative">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('backend.admin-univ-usulan.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => 'sk_jabatan_terakhir']) }}"
                           target="_blank"
                           class="inline-flex items-center gap-2 text-xs font-semibold text-indigo-600 hover:text-indigo-800 hover:underline transition-colors bg-indigo-50 px-3 py-2 rounded-lg hover:bg-indigo-100">
                            <i data-lucide="eye" class="w-3 h-3"></i>Lihat File Saat Ini
                        </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="group">
                ...
                <div class="relative">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('backend.admin-univ-usulan.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => 'skp_tahun_pertama']) }}"
                           target="_blank"
            ...
            <div class="group">
                ...
                <div class="relative">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('backend.admin-univ-usulan.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => 'skp_tahun_kedua']) }}"
                           target="_blank"
                           class="inline-flex items-center gap-2 text-xs font-semibold text-indigo-600 hover:text-indigo-800 hover:underline transition-colors bg-indigo-50 px-3 py-2 rounded-lg hover:bg-indigo-100">
                            <i data-lucide="eye" class="w-3 h-3"></i>Lihat File Saat Ini
                        </a>
            ...
            <div id="field_pak_konversi" class="hidden group">
                ...
                <div class="relative">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('backend.admin-univ-usulan.data-pegawai.show-document', ['pegawai' => $pegawai, 'field' => 'pak_konversi']) }}"
                           target="_blank"
                           class="inline-flex items-center gap-2 text-xs font-semibold text-indigo-600 hover:text-indigo-800 hover:underline transition-colors bg-indigo-50 px-3 py-2 rounded-lg hover:bg-indigo-100">
                            <i data-lucide="eye" class="w-3 h-3"></i>Lihat File Saat Ini
                        </a>
