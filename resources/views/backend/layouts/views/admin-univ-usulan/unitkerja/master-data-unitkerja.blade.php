        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('backend.admin-univ-usulan.unitkerja.create') }}"
        ...
        <div class="bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl border border-white/30 overflow-hidden">
            ...
            <div class="p-6">
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-200/50 overflow-hidden">
                            ...
                            <div class="p-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <a href="{{ route('backend.admin-univ-usulan.unitkerja.edit', ['type' => 'unit_kerja', 'id' => $unitKerja->id]) }}"
                                           class="p-2 bg-white/20 rounded-lg hover:bg-white/30 transition-colors">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                            </svg>
                                        </a>
                                        <form action="{{ route('backend.admin-univ-usulan.unitkerja.destroy', ['type' => 'unit_kerja', 'id' => $unitKerja->id]) }}"
                                              method="POST"
                            ...
                            <div class="p-4 space-y-4">
                                ...
                                <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
                                    ...
                                    <div class="p-3 bg-gradient-to-r from-indigo-50 to-purple-50 border-b border-slate-200">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <h4 class="font-semibold text-slate-800">{{ $subUnitKerja->nama }}</h4>
                                                <span class="px-2 py-1 bg-indigo-100 text-indigo-700 rounded-lg text-xs font-medium">Sub Unit Kerja</span>
                                            </div>
                                            <div class="flex items-center gap-2">
                                                <a href="{{ route('backend.admin-univ-usulan.unitkerja.edit', ['type' => 'sub_unit_kerja', 'id' => $subUnitKerja->id]) }}"
                                                   class="p-1.5 bg-indigo-100 rounded-lg hover:bg-indigo-200 transition-colors">
                                                    <svg class="w-4 h-4 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                    </svg>
                                                </a>
                                                <form action="{{ route('backend.admin-univ-usulan.unitkerja.destroy', ['type' => 'sub_unit_kerja', 'id' => $subUnitKerja->id]) }}"
                                                      method="POST"
                                                      onsubmit="return confirm('Apakah Anda yakin ingin menghapus Sub Unit Kerja ini?')"
                                                      class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="p-1.5 bg-red-100 rounded-lg hover:bg-red-200 transition-colors">
                                    ...
                                    <div class="p-3 space-y-2">
                                        ...
                                        <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg border border-slate-200">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span class="px-2 py-1 bg-slate-100 text-slate-600 rounded-lg text-xs font-medium">Sub-sub Unit Kerja</span>
                                            </div>
                                            <div class="flex items-center gap-2">
                                                <a href="{{ route('backend.admin-univ-usulan.unitkerja.edit', ['type' => 'sub_sub_unit_kerja', 'id' => $subSubUnitKerja->id]) }}"
                                                   class="p-1.5 bg-slate-100 rounded-lg hover:bg-slate-200 transition-colors">
                                                    <svg class="w-4 h-4 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                    </svg>
                                                </a>
                                                <form action="{{ route('backend.admin-univ-usulan.unitkerja.destroy', ['type' => 'sub_sub_unit_kerja', 'id' => $subSubUnitKerja->id]) }}"
                                                      method="POST"
                                    ...
                                    @else
                                    <div class="p-3 text-center text-slate-500 text-sm">
                                        Belum ada Sub-sub Unit Kerja
                                    </div>
                                    @endif
                                </div>
                                @endforeach
                ...
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-semibold text-slate-600 mb-2">Belum ada Unit Kerja</h3>
                    <p class="text-slate-500 mb-6">Mulai dengan menambahkan Unit Kerja pertama</p>
                    <a href="{{ route('backend.admin-univ-usulan.unitkerja.create') }}"
                       class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-indigo-700 transition-all duration-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                        </svg>
