...
@section('title', 'Daftar Usulan - Admin Universitas')
            ...
            <div class="py-6 flex flex-wrap gap-4 justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">
                        Daftar Usulan Universitas
                    </h1>
                    <p class="mt-1 text-sm text-gray-500">
                        Kelola usulan yang telah dikirim dari fakultas
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $usulans->total() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $usulans->where('status_usulan', 'Diusulkan ke Universitas')->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">Diteruskan ke Penilai</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $usulans->where('status_usulan', 'Sedang Direview')->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $usulans->where('status_usulan', 'Perbaikan Usulan')->count() }}</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($usulans as $usulan)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $usulan->pegawai->unitKerja->subUnitKerja->unitKerja->nama ?? 'N/A' }}</div>
                                    <div class="text-sm text-gray-500">{{ $usulan->pegawai->unitKerja->subUnitKerja->unitKerja->kode ?? '' }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="text-gray-500">
                                        ...
                                        <p class="text-sm">Tidak ada usulan yang perlu divalidasi saat ini.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
