...
<section id="pengumuman" class="py-16 bg-gradient-to-br from-green-50 to-emerald-100">
    <div class="max-w-full mx-auto px-2 sm:px-4 lg:px-6">
        ...
        <div class="text-center mb-12">
            ...
            <h2 class="text-4xl font-bold text-gray-900 mb-4">Pengumuman Terkini</h2>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">Informasi penting dan pengumuman resmi dari Universitas Mulawarman</p>
        </div>
