<!-- Berita Section -->
<section id="berita" class="py-16 bg-gradient-to-br from-blue-50 to-indigo-100">
    <div class="max-w-full mx-auto px-2 sm:px-4 lg:px-6">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">Dapatkan informasi terbaru seputar kegiatan dan perkembangan Universitas Mulawarman</p>
        </div>
                ...
                <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group cursor-pointer"
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-blue-600 font-medium text-sm group-hover:text-blue-800 transition-colors duration-300">
                                Baca selengkapnya →
                            </div>
                        </div>
                    </div>
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-8 max-w-md mx-auto">
                        ...
                        <p class="text-gray-600">Berita akan segera hadir untuk Anda.</p>
                    </div>
                </div>
            @endforelse
        </div>
        ...
        <div class="text-center">
            <a href="{{ route('frontend.berita') }}"
               class="inline-flex items-center px-8 py-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300">
